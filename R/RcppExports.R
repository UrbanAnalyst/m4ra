...
#' @noRd
rcpp_add_net_to_gtfs <- function(t_net_to_gtfs, gtfs_times, gtfs_to_net_index, gtfs_to_net_dist, nverts) {
    .Call(`_m4ra_rcpp_add_net_to_gtfs`, t_net_to_gtfs, gtfs_times, gtfs_to_net_index, gtfs_to_net_dist, nverts)
}
...
#'
#' @noRd
rcpp_weighted_dists <- function(graph, vert_map_in, fromi, toi_in, weights, dlim, k) {
    .Call(`_m4ra_rcpp_weighted_dists`, graph, vert_map_in, fromi, toi_in, weights, dlim, k)
}
